...
import (
	...
	"github.com/Cousin-Zan/influx-stress/lineprotocol"
	"github.com/Cousin-Zan/influx-stress/point"
	"github.com/Cousin-Zan/influx-stress/stress"
	"github.com/Cousin-Zan/influx-stress/write"
	"github.com/spf13/cobra"
)

var (
	statsHost, statsDB                       string
	host, db, tk, rp, precision, consistency string
...
func init() {
	...
	insertCmd.Flags().StringVarP(&db, "tk", "", "", "Database connect token")
